...
the standard criticality spectrum.
% NOTE for Christian (Claude): la citazione M&C 2023 e' inserita (chiave
% altWeighting, voce verificata su IRIS del Politecnico). Manca ancora il
% proseguimento a PHYSOR 2026 con SCONE: non e' depositato su IRIS ne' sotto
% il tuo nome ne' sotto quello di Abrate, quindi non riesco a ricostruirne
% titolo e autori. Se me li mandi lo aggiungo qui, la voce "scone" e' pronta.
