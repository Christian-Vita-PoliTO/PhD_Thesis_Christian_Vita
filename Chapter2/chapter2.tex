...
% the optimization of the energy grid belong to Chapters 3 and 4.
%
...
have to be analyzed. Chapter~\ref{ch:energy-grid} concerns the energy grid on
...
the flux, which is the unknown of the very problem the constants are meant to
