...
would add degrees of freedom to the test. Resampling confirms it: drawn from a hundred
searches the estimate is $+0.20$, from three hundred $+0.21$ and from the
thousand $+0.22$, while the interval between the tenth and ninetieth percentiles
of the resampled value narrows from $0.05$ to $0.03$, so that further searches
narrow the confidence interval without displacing the estimate.
...
quantity is $0.278$ for the block that prevails against $0.172$ for the one that
...
flux the two are close, at $0.237$ against $0.252$. The separation
...
\midrule
    ...
    Shape variation, importance weighted & 0.278 & 0.172 \\
...
$9.7$ of the 29 boundaries. The left panel of
...
$E$ [MeV] & Occ.\ [\%] & Imp.\ [\%] & Best \\ \midrule
    $3.68$ & 25 & 0.2 &  & $2.03\times10^{-3}$ & 78 & 5.0 & $\bullet$ \\
    $2.23$ & 89 & 0.4 & $\bullet$ & $1.23\times10^{-3}$ & 69 & 4.7 & $\bullet$ \\
    $1.35$ & 0 & 0.7 &  & $7.49\times10^{-4}$ & 76 & 3.9 &  \\
    $8.21\times10^{-1}$ & 2 & 1.6 &  & $4.54\times10^{-4}$ & 45 & 2.9 & $\bullet$ \\
    $4.98\times10^{-1}$ & 0 & 2.3 &  & $3.04\times10^{-4}$ & 87 & 2.9 & $\bullet$ \\
    $3.02\times10^{-1}$ & 9 & 2.9 &  & $1.49\times10^{-4}$ & 21 & 3.1 &  \\
    $1.83\times10^{-1}$ & 96 & 4.0 & $\bullet$ & $9.17\times10^{-5}$ & 51 & 1.9 &  \\
    $1.11\times10^{-1}$ & 66 & 4.4 & $\bullet$ & $6.79\times10^{-5}$ & 45 & 1.7 &  \\
    $6.74\times10^{-2}$ & 70 & 4.7 &  & $4.02\times10^{-5}$ & 37 & 2.1 &  \\
    $4.09\times10^{-2}$ & 58 & 4.7 &  & $2.26\times10^{-5}$ & 48 & 2.0 & $\bullet$ \\
    $2.48\times10^{-2}$ & 66 & 4.8 & $\bullet$ & $1.37\times10^{-5}$ & 77 & 1.8 & $\bullet$ \\
    $1.50\times10^{-2}$ & 59 & 5.1 &  & $8.32\times10^{-6}$ & 91 & 1.8 &  \\
    $9.12\times10^{-3}$ & 62 & 4.6 & $\bullet$ & $4.00\times10^{-6}$ & 82 & 2.4 & $\bullet$ \\
    $5.53\times10^{-3}$ & 69 & 4.6 & $\bullet$ & $5.40\times10^{-7}$ & 26 & 7.6 &  \\
    $3.35\times10^{-3}$ & 74 & 4.9 & $\bullet$ &  & & &  \\
\bottomrule
\end{tabular}
\end{table}
...
($r_s = -0.30$) and against the flux surrounding the boundary
($r_s = -0.12$). The three boundaries of the fast region where the spectrum
bends most sharply, at $1.35$, $0.821$ and $0.498$~MeV, are used by at most one
structure in fifty, although the region they subdivide, between $2.231$ and
$0.302$~MeV, carries $23\%$ of the flux.
...
variation of the importance contained in its groups gives $0.645$ for the ten
...
\begin{figure}[htbp]
  ...
  which each internal boundary is selected among the 747 distinct structures, in
...
\begin{figure}[htbp]
  ...
  747 distinct structures placed on a plane by multidimensional scaling of the
