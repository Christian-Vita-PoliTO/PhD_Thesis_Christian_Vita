...
over the configurations of the training database, 89\,723 of them, after the
controls described above have been applied and after discarding the
calculations that failed to converge. The window is therefore a property of
that data set and not of the individual search, and it is held fixed for every
search reported here, since changing it would move the scale and make the
values of different campaigns incomparable. This fixed window, and the fitness
values expressed through it, are referred to as canonical in the following. The two ends of the window are not of the same kind. The upper end is a
