...
Figure of merit & Optimized & Equal & Uniform & Finest \\
    ...
    $f_{k,\mathrm{out}}$ & 6.4 & 1.0 & 3.2 & 4.6 \\
    $f_{k,\mathrm{partial}}$ & 1.0 & 7.2 & 9.6 & 11.3 \\
    $f_{k,\mathrm{in}}$ & 53.0 & 70.4 & 72.2 & 75.7 \\
    $f_{\beta,\mathrm{out}}$ & 1.0 & 52.7 & 83.6 & 89.5 \\
    $f_{\beta,\mathrm{partial}}$ & 1.0 & 19.1 & 51.6 & 57.6 \\
    $f_{\beta,\mathrm{in}}$ & 24.9 & 1.0 & 1.0 & 1.0 \\
    $f_{\ell,\mathrm{out}}$ & 1.0 & 1.0 & 1.0 & 1.0 \\
    $f_{\ell,\mathrm{partial}}$ & 1.0 & 1.0 & 1.0 & 1.0 \\
    $f_{\ell,\mathrm{in}}$ & 1.0 & 1.0 & 1.0 & 1.0 \\
    $f_{P,\mathrm{out}}$ & 4.5 & 14.6 & 15.8 & 14.2 \\
    $f_{P,\mathrm{partial}}$ & 6.9 & 15.3 & 17.6 & 17.4 \\
    $f_{P,\mathrm{in}}$ & 32.4 & 38.2 & 39.8 & 39.3 \\
...
Rank & $G$ & True fitness & Predicted & Disagr.\ [\%] & Worst output \\ \midrule
    1 & 18 & $8.558\times10^{6}$ & $8.318\times10^{6}$ & 2.8 & $f_{\Phi,\mathrm{in}}$ (10\%) \\
    2 & 19 & $8.606\times10^{6}$ & $8.674\times10^{6}$ & 0.8 & $f_{\Phi,\mathrm{in}}$ (18\%) \\
    3 & 17 & $8.664\times10^{6}$ & $8.605\times10^{6}$ & 0.7 & $f_{\Phi,\mathrm{in}}$ (12\%) \\
    4 & 17 & $8.705\times10^{6}$ & $8.725\times10^{6}$ & 0.2 & $f_{\Phi,\mathrm{in}}$ (7\%) \\
    5 & 19 & $8.854\times10^{6}$ & $8.727\times10^{6}$ & 1.4 & $f_{k,\mathrm{partial}}$ (12\%) \\
    6 & 15 & $8.926\times10^{6}$ & $8.739\times10^{6}$ & 2.1 & $f_{\Phi,\mathrm{in}}$ (6\%) \\
    7 & 17 & $8.996\times10^{6}$ & $8.437\times10^{6}$ & 6.2 & $f_{k,\mathrm{partial}}$ (6\%) \\
    8 & 18 & $9.006\times10^{6}$ & $8.513\times10^{6}$ & 5.5 & $f_{\Phi,\mathrm{in}}$ (13\%) \\
    9 & 20 & $9.031\times10^{6}$ & $8.914\times10^{6}$ & 1.3 & $f_{k,\mathrm{partial}}$ (27\%) \\
    10 & 17 & $9.049\times10^{6}$ & $8.564\times10^{6}$ & 5.4 & $f_{k,\mathrm{partial}}$ (7\%) \\
    11 & 18 & $9.056\times10^{6}$ & $8.488\times10^{6}$ & 6.3 & $f_{k,\mathrm{partial}}$ (13\%) \\
    12 & 17 & $9.070\times10^{6}$ & $9.252\times10^{6}$ & 2.0 & $f_{\Phi,\mathrm{in}}$ (9\%) \\
    13 & 15 & $9.084\times10^{6}$ & $9.022\times10^{6}$ & 0.7 & $f_{\Phi,\mathrm{in}}$ (5\%) \\
    14 & 20 & $9.098\times10^{6}$ & $8.949\times10^{6}$ & 1.6 & $f_{k,\mathrm{partial}}$ (28\%) \\
    15 & 16 & $9.130\times10^{6}$ & $8.852\times10^{6}$ & 3.0 & $f_{\beta,\mathrm{partial}}$ (64\%) \\
\bottomrule
\end{tabular}
\end{table}
