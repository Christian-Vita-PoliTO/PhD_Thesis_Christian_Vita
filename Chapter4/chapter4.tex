...
quantity and not the first: above $0.3$~MeV, where the groups carry the least
importance, the structures keep a single boundary and drop the other four,
while in the intermediate region, where the importance is spread evenly across
the groups, nearly every boundary is retained by more than half of them.
