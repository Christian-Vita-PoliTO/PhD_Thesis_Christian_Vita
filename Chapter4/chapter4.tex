...
accuracy figure quoted in this work refers to that set; the ablation and
reproducibility measurements of the next subsection are evaluated on it as
well, after the architecture had been fixed.
