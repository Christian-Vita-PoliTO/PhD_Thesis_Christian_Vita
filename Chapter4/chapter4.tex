...
\begin{figure}[htbp]
  ...
  boundaries of the fine mesh; below, the same fraction for the structures that
...
built. The fine mesh has thirty groups and the collapsing routine requires the
