...
How many entries a given accuracy requires cannot be stated beforehand, and
the number was settled by a nested procedure: a coarse database is built first, its
