...
Neither the design nor the operation of a reactor asks for a single state of the
core. A design space is explored over the positions of the control system, the
temperatures and the states of the fuel; a fuel cycle is a sequence of states;
the monitoring of an operating core requires its critical configuration to be
predicted as the core evolves. A Monte Carlo calculation of the critical state
