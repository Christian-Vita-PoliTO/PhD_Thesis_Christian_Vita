...
This thesis acts on that representation along two lines. The first is the way it
is built: the route by which the group constants are generated and the energy
mesh over which they are condensed in Part~\ref{part:lfr}, the parameters spanned
by the database, its density and the interpolation of its matrices in
Part~\ref{part:hpmr}. The second is the correction, a quantity computed from a
